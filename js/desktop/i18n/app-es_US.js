...
(function (scope){
  ...
  scope.translations['es_US'] = scope.translations['es_US'] || {};

          // Module              : combobox
          scope.translations['es_US'].combobox= {
                    not_in_list : 'Seleccione un elemento de la lista.',
          };

          // Module              : activity index
          scope.translations['es_US'].activity_index= {
          ...
          // Module              : loader
          scope.translations['es_US'].loading = 'cargando...';
          scope.translations['es_US'].serverError= {
          ...
          scope.translations['en_US'].validationError= {
                    message : 'Ha habido un problema validando tu petición',
                    title : 'Error de validación',
          };

          // Module              : buttons
          scope.translations['es_US'].buttons= {
                    accept : 'Aceptar',
                    cancel : 'Cancelar',
                    ok : 'OK',
                    remove: 'Remove'
          ...
          scope.translations['es_US'].monthly_report= {
                    activities : {
          ...
          scope.translations['es_US'].periods= {
                    form : {
                              cancel : 'Cancelar',
                              commit : 'Aplicar',
                              edit_title : 'Editar',
          ...
          scope.translations['es_US'].rules= {
                    descriptions : {
          ...
          scope.translations['es_US'].times= {
                    all_day : 'Todo el dia',
                    days : 'Días',
          ...
          scope.translations['es_US'].weekdays= {
                    friday : 'viernes',
                    monday : 'lunes',
                    saturday : 'sábado',
                    sunday : 'domingo',
