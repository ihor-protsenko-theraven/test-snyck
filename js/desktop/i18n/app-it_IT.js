...
(function (scope){
  ...
  scope.translations['it_IT'] = scope.translations['it_IT'] || {};

          // Module              : combobox
          scope.translations['it_IT'].combobox= {
                    not_in_list : 'Seleziona una voce dall\'elenco',
          };

          // Module              : activity index
          scope.translations['it_IT'].activity_index= {
          ...
          // Module              : loader
          scope.translations['it_IT'].loading = 'Caricamento in corso...';
          scope.translations['it_IT'].serverError= {
          ...
          // Module              : buttons
          scope.translations['it_IT'].buttons= {
          ...
          scope.translations['it_IT'].monthly_report= {
                    activities : {
          ...
          scope.translations['it_IT'].periods= {
                    form : {
          ...
          scope.translations['it_IT'].rules= {
                    descriptions : {
          ...
          scope.translations['it_IT'].times= {
          ...
          scope.translations['it_IT'].weekdays= {
