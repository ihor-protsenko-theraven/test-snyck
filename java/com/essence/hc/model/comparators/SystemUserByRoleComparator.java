...
public class SystemUserByRoleComparator implements Comparator<SystemUser> {

	@Override
	public int compare(SystemUser u1, SystemUser u2) {
		if (u1 == null || u1.getUserType() == null) {
			if (u2 == null || u2.getUserType() == null) {
				return 0;
			} else {
				return -1;
			}
		} else if (u2 == null || u2.getUserType() == null) {
			return 1;
		}
